...
public class Constants {
    ...
    public interface ACTION {
        ...
        String BROADCAST_GYRO_DATA = "edu.umass.cs.my-activities-toolkit.action.broadcast-gyro-data";
        ...
        String BROADCAST_LOCAL_REP_COUNT = "edu.umass.cs.my-activities-toolkit.action.broadcast-local-rep-count";
        String BROADCAST_SERVER_REP_COUNT = "edu.umass.cs.my-activities-toolkit.action.broadcast-server-rep-count";
        ...
        String BROADCAST_ACCELEROMETER_PEAK = "edu.umass.cs.my-activities-toolkit.action.broadcast-gyro-peak";
        String BROADCAST_GYRO_PEAK = "edu.umass.cs.my-activities-toolkit.action.broadcast-accelerometer-peak";
        ...
        String BROADCAST_AVERAGE_ANGULAR_VELOCITY = "edu.umass.cs.my-activities-toolkit.action-broadcast-average-angular-velocity";
    }
    ...
    public interface KEY {
        ...
        String GYRO_DATA = "edu.umass.cs.my-activities-toolkit.key.gyro-data";
        ...
        String REP_COUNT = "edu.umass.cs.my-activities-toolkit.key.rep-count";
        String GYRO_PEAK_TIMESTAMP = "edu.umass.cs.my-activities-toolkit.key.gyro-peak-timestamp";
        String GYRO_PEAK_VALUE = "edu.umass.cs.my-activities-toolkit.key.gyro-peak-value";
        String AVERAGE_ANGULAR_VELOCITY = "edu.umass.cs.my-activities-toolkit.key.average-angular-velocity";
    }
    ...
    public interface ERROR_MESSAGES {
        ...
        String ERROR_NO_GYRO = "ERROR: No gyroscope available...";
