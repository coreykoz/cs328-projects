 ...
 * <br><br>
 * As an example, to listen for steps, excercise reps, and activities detected, register a
 ...
 * </pre>
 *
 * @authors Sean Noran and Jeremy Gummeson
 */
public interface MHLClientFilter {
    String AVERAGE_ACCELERATION = "AVERAGE_ACCELERATION";
    String AVERAGE_ANGULAR_VELOCITY = "AVERAGE_ANGULAR_VELOCITY";
    String STEP = "STEP";
