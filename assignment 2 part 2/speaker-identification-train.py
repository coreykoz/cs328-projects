...
class_names = ["corey", "mike", "nospeaker", "ugonna"] # the set of classes, i.e. speakers
...
formants_bin_count = 20
delta_coe_count = 975
delta_delta_count = 0 #tried adding another feature, didnt help accuracy
n_features = formants_bin_count + delta_coe_count + delta_delta_count
