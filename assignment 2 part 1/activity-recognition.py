...
class_names = ["stairs", "sitting", "standing", "walking"]
...
def predict(window):
    ...
    feature_names, feature_vals = extract_features(window)
    #print("FEATURE VECTOR", feature_vector)
    feature_vector = []

    feature_vector.append(feature_vals)
    ...
    pred_classes = classifier.predict(feature_vector)
    ...
    onActivityDetected(class_names[pred_classes[0]])
    return
